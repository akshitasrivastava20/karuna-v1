            ...
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    {links.map((link, index) => (
                        <Link
                            key={index}
                            href={link.href}
                            className="text-amber-800 hover:text-amber-600 block duration-150">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    ...
                    <Link
                        ...
                        className="text-amber-800 hover:text-amber-600 block">
                ...
                <span className="text-amber-800 block text-center text-sm"> © {new Date().getFullYear()} Akshita Srivastava &Dev Shakya</span>
            </div>
        </footer>
    )
}